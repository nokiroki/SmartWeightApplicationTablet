...
public class JsonEncoderDecoder {
    ...
    static public JSONObject queryActivateDeactivateReader(boolean info) throws JSONException {
        JSONObject json = new JSONObject();
    ...
    static public HashMap<Integer, ObjectStructures.DishParams> getActualDishList
        ...
        if (json.getString("query").equals("GetDishNames")) {
            ...
            for (int i = 0; i < dishes.length(); i++ ) {
                ...
                int photoId = context.getResources().getIdentifier(object.getString("photo"),
